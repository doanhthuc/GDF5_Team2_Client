    ...
    try {
        ...
        this.server.onMessage = function(evt) {
            ...
            try {
                ...
                console.log("Poco::onMessage - error when handling rpc request. req=" + evt.data + '\nerror message: ' + error.stack)
            }
        };

        this.server.onDisconnection = function(evt) {
            console.log('Poco::onDisconnection...');
            console.log(JSON.stringify(evt));
        };

        this.server.onError = function(evt) {
            console.log('Poco::onerror...');
            console.log(JSON.stringify(evt));
        };
        ...
        console.log("Poco::onError - " + err.stack + "\n" + err.message);
    }
};
